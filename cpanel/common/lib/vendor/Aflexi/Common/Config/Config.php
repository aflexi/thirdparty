...
interface Aflexi_Common_Config_Config{
    ...
    /**
     * Export config entries for all or selected namespace.
     * 
     * @param string $namespace[optional] If NULL, all entries will be exported.
     * @param mixed $var[optional] If provided, exported values will be written to here instead.
     * @return mixed The exported values or void if $var is provided.
     */
    function export($namespace = NULL, &$var = NULL);
