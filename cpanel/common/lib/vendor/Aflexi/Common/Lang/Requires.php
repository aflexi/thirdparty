...
require_once 'Aflexi/Common/IO/FileNotFoundException.php';
require_once 'Aflexi/Common/IO/Files.php';
...
final class Aflexi_Common_Lang_Requires{
    ...
    public static function requirePhpUnit(){
        // NOTE [yclian 20101012] For PHPUnit 3.5.x, PHPUnit_Autoload shall be 
        // used instead.
