 ...
 */
class Aflexi_Common_Template_Factory{
    
    /**
     * @var Aflexi_Common_Template_Factory
     */
    ...
    /**
     * @return Aflexi_Common_Template_Factory
     */
    static function getInstance(){
        return self::$instance;
    }
    
    static function setInstance(Aflexi_Common_Template_Factory $instance){
