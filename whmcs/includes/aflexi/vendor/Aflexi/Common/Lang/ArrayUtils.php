 ...
 */
final class Aflexi_Common_Lang_ArrayUtils{
...
if(!function_exists('is_assoc')){
    ...
    /**
     * @see Aflexi_Common_Lang_ArrayUtils#isAssociative()
     * @param $array
     * @return bool
     */
    function is_assoc($array) {
        return Aflexi_Common_Lang_ArrayUtils::isAssociative($array);
    }
}
...
if(!function_exists('array_get')){
    ...
    /**
     * @see Aflexi_Common_Lang_ArrayUtils#get()
     * @param $array
     * @param $key
     * @param $default_value
     * @return mixed
    ...
    function array_get($array, $key, $default_value = NULL) {
        return Aflexi_Common_Lang_ArrayUtils::get($array, $key, $default_value);
    }
}
...
if(!function_exists('array_rebuild_keys')){
     ...
     * @since 2.6
     * @version 2.6.20100715
     * @see Aflexi_Common_Lang_ArrayUtils#rebuildKeys()
     * @param $array
     * @param $key
     */
    function array_rebuild_keys($array, $key){
        return Aflexi_Common_Lang_ArrayUtils::rebuildKeys($array, $key);
    }
}
...
if(!function_exists('assoc_to_object')){
    ...
    /**
     * @see Aflexi_Common_Lang_ArrayUtils#toObject()
     * @param $assoc
     * @return mixed
     */
    function assoc_to_object($assoc){
        return Aflexi_Common_Lang_ArrayUtils::toObject($assoc);
    }
}
