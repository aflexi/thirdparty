 ...
 */
final class Aflexi_Common_Lang_StringUtils{
...
if(!function_exists('lcfirst')){
    ...
    /**
     * @see Aflexi_Common_Lang_StringUtils#toLowerCaseFirstCharacter()
     * @param string $str
     * @return string     
     */
    function lcfirst($str){
        return Aflexi_Common_Lang_StringUtils::toLowerCaseFirstCharacter($str);
    }
}
